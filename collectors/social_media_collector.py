"""
HYDRA INTEL - Social Media Collector

Collects social media intelligence using the tool registry with failover
(maigret, sherlock, blackbird, whatsmyname, snscrape, twint, etc.).
"""
...
class SocialMediaCollector(EnhancedBaseCollector):
    ...
    def target_type(self) -> TargetType:
        return TargetType.SOCIAL_MEDIA_INTEL

    @property
    def default_query(self) -> str:
        return "security breach threat"
